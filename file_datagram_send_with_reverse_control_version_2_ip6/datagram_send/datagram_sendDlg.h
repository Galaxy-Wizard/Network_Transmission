...
public:
	...
	afx_msg void OnEnChangeEditAddressLocal();
	afx_msg void OnEnChangeEditAddressPortNumberLocal();
	afx_msg void OnEnChangeEditAddressLocalReverseControl();
	afx_msg void OnEnChangeEditAddressPortNumberLocalReverseControl();
