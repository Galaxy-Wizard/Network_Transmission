...
// datagram_send.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cdatagram_sendApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание Cdatagram_sendApp

Cdatagram_sendApp::Cdatagram_sendApp()
{
...
// Единственный объект Cdatagram_sendApp

Cdatagram_sendApp theApp;


// инициализация Cdatagram_sendApp

BOOL Cdatagram_sendApp::InitInstance()
{
